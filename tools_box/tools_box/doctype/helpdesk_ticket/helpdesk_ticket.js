...
cur_frm.cscript.add_buttons = function (frm) {
    ...
    cur_frm.add_custom_button('Make Work Card', function () {
        var jc = frappe.model.make_new_doc_and_get_name('Work Card');
        jc = locals['Work Card'][jc];
	...
	jc.employee_name = cur_frm.doc.raised_by_name;
        frappe.set_route("Form", "Work Card", jc.name);
    });
